...
function getNameAndImage() {
  FB.api('/me', function(response) {
    ...
    window.vm.username = response.name;
    //window.vuejs_logout.userimg = "https://graph.facebook.com/"+response.id+"/picture";
...
function statusChangeCallback(response) {
  ...
  if (response.status === 'connected') {
    ...
    //document.getElementById('vuejs_login').style.visibility = "visible";
    //document.getElementById('loginBtn').style.visibility = "inherit";
  }
}

window.loginFn = function () {
  FB.login(statusChangeCallback);
           //{scope: 'user_birthday, public_profile, user_friends, email, user_about_me, user_education_history,user_location, '});
};
